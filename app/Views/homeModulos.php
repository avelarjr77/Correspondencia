                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-7" style="text-align: center;"><br>
                        <div class="card-body">
                            ...
                            <form class="text-center" id="moduloId" action="<?php echo base_url() . '/homeMenus' ?>"
                                method="POST">
                                <button type="submit" class="btn btn-dark btn-sm center"
                                    style="border-radius:5px;padding:7px 15px;color:white;background-color:#305274">
                                    Ir al modulo
                                </button>
                                <input type="hidden" name="moduloId" class="moduloId" id="moduloId"
                                    value="<?= $key->moduloId ?> ">
                            </form>
                        </div>
                    </div>

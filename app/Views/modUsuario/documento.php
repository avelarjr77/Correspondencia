        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <button type="button" class="btn btn-outline-success mb-2" data-toggle="modal"
                    data-target="#agregarModal"><i class="fa fa-plus"></i> Agregar Documento</button>
                <a href="<?= base_url().route_to('tipoEnvio') ?>" class="btn btn-outline-secondary mb-2"><i
                        class="fa fa-cogs"></i> Configurar tipo de envio</a>
                <br>
...
>>>>>>> 02f1223c363f4f821fbdbdc060ab1713cd8900a3
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="field item form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input minlength="6" maxlength="75" type="text"
                                                class="form-control nombreDocumento" id="nombreDocumento"
                                                name="nombreDocumento" required autocomplete="off">
                                    ...
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-2 label-align">Tipo Documento <span
                                                class="required">*</span></label>
                                        <div class="col-md-8">
                                            <select name="tipoDocumentoId" id="tipoDocumentoId" required="required"
                                                class="form-control tipoDocumentoId">
                                                <option value="">-Selecciona un tipo de documento-</option>
                                                <?php foreach ($tipoDocumento as $td): ?>
                                                <option value="<?php echo $td->tipoDocumentoId ?>">
                                                    <?php echo $td->tipoDocumento ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-2 label-align">Tipo de Envio <span
                                                class="required">*</span></label>
                                        <div class="col-md-8">
                                            <select name="tipoEnvioId" id="tipoEnvioId" required="required"
                                                class="form-control tipoEnvioId">
                                                <option value="">-Selecciona un tipo de Envio-</option>
                                                <?php foreach ($tipoEnvio as $te): ?>
                                                <option value="<?php echo $te->tipoEnvioId ?>">
                                                    <?php echo $te->tipoEnvio ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-2 label-align">Transaccion
                                            Actividad <span class="required">*</span></label>
                                        <div class="col-md-8">
                                            <select name="transaccionActividadId" required="required"
                                                id="transaccionActividadId" class="form-control transaccionActividadId">
                                                <option value="">-Selecciona tipo de transaccion-</option>
                                                <?php foreach ($datos as $d): ?>
                                                <option value="<?php echo $d->transaccionActividadId ?>">
                                                    <?php echo $d->transaccionActividadId ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Nombre
                                            documento<span class="required ">*</span></label>
                                        <div class="col-md-8">
                                            <input class="form-control nombreDocumento" id="nombreDocumento"
                                                name="nombreDocumento" type="text" required autocomplete="off">
                                            <span class="fa fa-user form-control-feedback right"
                                                aria-hidden="true"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-2 label-align">Transaccion
                                            Actividad <span class="required">*</span></label>
                                        <div class="col-md-8">
                                            <select name="transaccionActividadId" id="transaccionActividadId"
                                                class="form-control">
                                                <option value="">-Selecciona tipo de transaccion-</option>
                                                <?php foreach ($datos as $d): ?>
                                                <option value="<?php echo $d->transaccionActividadId ?>">

                  ...
                  <ul class="nav child_menu">
                    <li><a><i class="fa fa-edit"></i> Admin. Rol-Módulo <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                        ...
                        <li><a href="<?= base_url() . route_to('adminRolModMenu') ?>">2. Admin. Rol-Módulo-Menú</a></li>
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open" style="padding-left: 15px;">
                ...
                <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="<?= base_url() . route_to('login') ?>"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                </div>
              </li>

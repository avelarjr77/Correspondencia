...
<div class="x_panel">
    ...
    <div class="x_content">
                ...
                <tbody>
                    <?php foreach ($datos as $rol) : ?>
                        <tr>
                            ...
                            <td><a href="#" class="btn btn-outline-secondary btn-sm btn-modulo" data-id="<?php echo $rol->rolId ?>" data-nombre="<?php echo $rol->nombreRol ?>"><i class=" fa fa-th"></i> Módulos</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
        ...
        <!-- Modal Agregar Rol-->
        <form action="<?php echo base_url() . '/crearRol' ?>" method="POST">
            <div class="modal fade" id="modalRolModulo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Agregar un nuevo Modulo a <b><i class="rolNombre"></i></b></h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                ...
                                <?php foreach ($Modulo as $key) : ?>
                                    <label class="">
                                        <div class="icheckbox_flat-green checked" style="position: relative;"><input type="checkbox" class="flat" checked="checked" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> 
                                        <?php echo $key->nombre ?>
                                    </label>
                                    <?php endforeach; ?>
                                </div>
                                <div class="checkbox">
                                    <label class="">
                                        <div class="icheckbox_flat-green checked" style="position: relative;"><input type="checkbox" class="flat" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> Unchecked
                                    </label>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        // get Delete Product
        $('.btn-modulo').on('click', function() {
            // get data from button edit
            const id = $(this).data('id');
            const nombre = $(this).data('nombre');
            // Set data to Form Edit
            $('.rolId').val(id);
            $('.rolNombre').html(nombre);
            // Call Modal Edit
            $('#modalRolModulo').modal('show');
        });

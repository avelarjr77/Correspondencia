                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form id="eliminarForm" data-bs-action="nombreMenu/delete/" method="POST">
                    ...
                    <tbody>
                        <?php foreach ($datos as $key) : ?>
                            <tr>
                                ...
                                <td>
                                    <button type="submit" class="btn btn-danger" data-bs-menuId="<?php echo $key->menuId ?>" data-toggle="modal" data-target="#modalEliminar"><i class="fa fa-trash"></i></button>
...
<script>
    ...
    modalEliminar.addEventListener('show.bs.modal', function(event) {
        ...
        var recipient = button.getAtribute('data-bs-menuId')

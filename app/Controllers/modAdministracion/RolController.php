...
class RolController extends BaseController
{
    ...
    public function eliminar()
    {
        ...
        //Para buscar si el Rol está relacionado con un usuario
        $buscarRelacion = $usuario->select('rolId')->where('rolId', $rolId)->first();
        if ($buscarRelacion) {
            return redirect()->to(base_url() . '/adminRol')->with('mensaje', '6');
        }
